...
<body>
    ...
    <div class="z_wyg">恭喜你获得三等奖,您将获得<br/><span>圣蜜莱雅丝白优肌补水睡眠面膜120g</span>一份</div>
    <form class="submitform" method="post" action="data.php"  onSubmit="return checkMobile();">
        <p class="z_notice">请填写相关信息，以便工作人员与你联系，确认派奖事宜。</p>
        <input type="hidden" name="level" value="3">
        <input type="hidden" name="levelc" value="三">
        <input type="hidden" name="wyg" value="圣蜜莱雅丝白优肌补水睡眠面膜120g"/>
